...
const ProductItem = ({ productHash }: ProductItemProps) => {
	...
	return (
		...
		<>
			...
			<div
				className="grid grid-cols-10 gap-4 p-2 my-2 min-w-full min-h-[90px] rounded-md bg-itemfade border border-neutral hover:border-black hover:cursor-pointer overflow-hidden"
				// @ts-ignore
